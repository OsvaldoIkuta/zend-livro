...
class Usuario
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="dt_criado_em", type="datetime", nullable=false, options={"default"="CURRENT_TIMESTAMP","comment"="Data de crição do registro"})
     */
     ...
     * @var \TbTipoUsuario
     *
     * @ORM\ManyToOne(targetEntity="TbTipoUsuario")
     * @ORM\JoinColumns({
